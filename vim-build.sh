...
sudo checkinstall -D --install=yes --pkgname='vim' --pkgversion='7.4' --pkglicense='Charityware' --maintainer='dzienniak.tymoteusz@gmail.com' --showinstall=no --default --fstrans=yes --deldoc=yes --deldesc=yes --backup=no
